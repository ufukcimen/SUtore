...
export function ReviewModerationPage() {
  ...
  if (user && !isManager) {
    return (
      <StorefrontPageShell
        contextLabel="Moderation workspace"
        currentStep=""
        description=""
        eyebrow="Access denied"
        title="This area is for product managers."
      >
        <section className="rounded-lg border border-rose-200 bg-rose-50 px-6 py-10 text-center text-rose-900 shadow-sm">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-md bg-rose-100">
    ...
    >
      ...
      {!isLoading && !errorMessage && reviews.length === 0 ? (
        <section className="rounded-lg border border-dashed border-slate-300 bg-white px-6 py-10 text-center shadow-sm">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-slate-950">All caught up.</h2>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex shrink-0 flex-wrap items-center gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-md border border-emerald-200 bg-emerald-50 px-4 py-2.5 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-100 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={actionLoadingId === review.review_id}
                    className="inline-flex items-center gap-2 rounded-md border border-rose-200 bg-rose-50 px-4 py-2.5 text-sm font-semibold text-rose-700 transition hover:bg-rose-100 disabled:opacity-50"
                  >
